...
const withAuth0_1 = require('../withAuth0');
...
`;
describe(withAuth0_1.addAuth0GradleValues, () => {
  it(`modifies the build.gradle`, () => {
    expect(
      withAuth0_1.addAuth0GradleValues(
        buildGradleFixture,
        'com.example.app',
        'com.example.app',
      ),
...
describe(withAuth0_1.addAuth0AppDelegateCode, () => {
  it(`modifies the build.gradle`, () => {
    expect(
      withAuth0_1.addAuth0AppDelegateCode(appDelegateFixtures),
    ).toMatchSnapshot();
  });
});
