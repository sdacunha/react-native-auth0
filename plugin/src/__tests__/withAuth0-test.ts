...
const appDelegateFixturesWithLinking = `
...
const appDelegateFixturesWithoutLinking = `
// This AppDelegate template is used in Expo SDK 43 and newer
// It is (nearly) identical to the pure template used when
// creating a bare React Native app (without Expo)
...
describe(addAuth0AppDelegateCode, () => {
  it(`modifies the AppDelegate`, () => {
    expect(
      addAuth0AppDelegateCode(appDelegateFixturesWithoutLinking),
    ).toMatchSnapshot();
  });
});
...
describe(addAuth0AppDelegateCode, () => {
  it(`does not modify the AppDelegate`, () => {
    expect(
      addAuth0AppDelegateCode(appDelegateFixturesWithLinking),
    ).toMatchSnapshot();
  });
});
